...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericRouteDetails) DeepCopyInto(out *GenericRouteDetails) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericRouteDetails.
func (in *GenericRouteDetails) DeepCopy() *GenericRouteDetails {
	if in == nil {
		return nil
	}
	out := new(GenericRouteDetails)
	in.DeepCopyInto(out)
	return out
}
