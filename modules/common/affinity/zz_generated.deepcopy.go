...
func (in *AffinityOverrideSpec) DeepCopyInto(out *AffinityOverrideSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AffinityOverrideSpec.
func (in *AffinityOverrideSpec) DeepCopy() *AffinityOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(AffinityOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
