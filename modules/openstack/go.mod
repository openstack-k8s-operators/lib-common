...
require (
	...
	k8s.io/api v0.26.11 // indirect; indirect // indirect
	...
	k8s.io/client-go v0.26.11 // indirect; indirect // indirect
	...
	k8s.io/utils v0.0.0-20231121161247-cf03d44ff3cf // indirect; indirect // indirect
