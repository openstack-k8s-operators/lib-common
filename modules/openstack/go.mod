...
require (
	...
	k8s.io/api v0.27.2 // indirect; indirect // indirect
	k8s.io/apiextensions-apiserver v0.27.2 // indirect; indirect // indirect
	k8s.io/apimachinery v0.27.2 // indirect; indirect // indirect
	k8s.io/client-go v0.27.2 // indirect; indirect // indirect
	k8s.io/component-base v0.27.2 // indirect; indirect // indirect
	k8s.io/klog/v2 v2.90.1 // indirect
	k8s.io/kube-openapi v0.0.0-20230501164219-8b0f38b5fd1f // indirect; indirect // indirect
	k8s.io/utils v0.0.0-20230313181309-38a27ef9d749 // indirect; indirect // indirect
	sigs.k8s.io/controller-runtime v0.15.0 // indirect; indirect // indirect
