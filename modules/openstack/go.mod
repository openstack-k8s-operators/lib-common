...
require (
	...
	k8s.io/apiextensions-apiserver v0.26.6 // indirect; indirect // indirect
	k8s.io/apimachinery v0.26.6 // indirect; indirect // indirect
	k8s.io/client-go v0.26.6 // indirect; indirect // indirect
...
replace github.com/openshift/api => github.com/openshift/api 81f778f3b3ec
