...
require (
	...
	k8s.io/api v0.26.7 // indirect; indirect // indirect
	k8s.io/apiextensions-apiserver v0.26.7 // indirect; indirect // indirect
	k8s.io/apimachinery v0.26.7 // indirect; indirect // indirect
	k8s.io/client-go v0.26.7 // indirect; indirect // indirect
