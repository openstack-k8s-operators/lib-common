...
require (
	...
	k8s.io/api v0.29.0 // indirect; indirect // indirect
	k8s.io/apiextensions-apiserver v0.26.12 // indirect; indirect // indirect
	k8s.io/apimachinery v0.29.0 // indirect; indirect // indirect
	k8s.io/client-go v0.29.0 // indirect; indirect // indirect
	k8s.io/component-base v0.26.12 // indirect; indirect // indirect
	k8s.io/klog/v2 v2.110.1 // indirect
	k8s.io/kube-openapi v0.0.0-20231010175941-2dd684a91f00 // indirect; indirect // indirect
